...
export interface User {
  ...
  completedRedLabs: string[];
  completedBlueLabs: string[];
}
...
export interface BlueLab {
  ...
  terminalEnabled: boolean;
  ports: number[];
  pairedRedLabId?: string; // For Purple Team cross-team labs
}

// Blue Team Module types
...
export interface LeaderboardEntry {
  ...
  redLabsCompleted: number;
  blueLabsCompleted: number;
  level?: number;
  streak?: number;
